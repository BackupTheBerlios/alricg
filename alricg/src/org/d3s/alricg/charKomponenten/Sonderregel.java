...
import org.d3s.alricg.prozessor.HeldProzessorAdapter;
 ...
 * @author V.Strelow
 */
public abstract class Sonderregel extends HeldProzessorAdapter {
	private String id;
...
//	oder "HeldGenerator" aufgerufen werden
	 ...
	 */
	public abstract int getMaxWertModi(CharElement element, CharKomponente komponente);
	public abstract int getMinWertModi(CharElement element, CharKomponente komponente);
     ...
     * @param komponente Die Art des Elements als CharKomponente 
	 */
	public abstract void addOther(CharElement element, CharKomponente komponente);
