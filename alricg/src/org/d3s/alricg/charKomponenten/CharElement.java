...
abstract public class CharElement implements Comparable<CharElement> {
	...
	/**
	 * @param anzeigenText Setzt den Text der angezeigt wird, wenn das Element nicht
	 * 		wählbar ist.
	 */
	...
	/**
	 * @param beschreibung Die Beschreibung für das Element, meist ein Verweis zu einem
	 * 		Regelbuch
	 */
	...
	/**
	 * @param sammelBegriff Der Sammelbegriff für das Element, dient der Zuordnung mehrer
	 * 		Elemente und der Struckturierung
	 */
     ...
     * die Anzeige bestimmt ist. Gilt es solch einen Text nicht, dann ""
	 */
