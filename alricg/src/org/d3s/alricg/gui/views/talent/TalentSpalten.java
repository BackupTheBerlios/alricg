...
/**
 * <u>Beschreibung:</u><br>
 * Schema für die Darstellung von Talenten in SortableTables. Hier sind alle Methoden zusammengefaßt, die NICHT von dem
 * dargestellten Objekt abhängen, sondern nur von der Objek-Art und der Spalte.
 * 
...
public class TalentSpalten implements SpaltenSchema {
    ...
    public enum Spalten {
        name("Name"), stern("*"), stufe("Stufe"), modis("Modis"), sorte("Sorte"), kostenKlasse("SKT"), kosten("Kosten"), art(
                "Art"), spezialisierungen("Spez."), auswahl("Auswahl"), leitTalent("L.T."), probe("Probe"), plus("+"), minus(
                "-");
    ...
    public Enum[] getSpalten(SpaltenArt art) {
        ...
        switch (art) {
        case objektDirekt:
            return new Spalten[] { Spalten.name, Spalten.stern, Spalten.sorte, Spalten.art, Spalten.kostenKlasse,
                    Spalten.probe, Spalten.plus, };

        case objektLinkGen:
            return new Spalten[] { Spalten.name, Spalten.stufe, Spalten.modis, Spalten.kostenKlasse, Spalten.kosten,
                    Spalten.art, Spalten.spezialisierungen, Spalten.auswahl, Spalten.leitTalent, Spalten.minus };
        ...
        case editorAuswahl:
            return new Spalten[] { Spalten.name, Spalten.sorte, Spalten.art, Spalten.kostenKlasse, Spalten.probe,
                    Spalten.plus };
        case editorGewaehlt:
            return new Spalten[] { Spalten.name, Spalten.sorte, Spalten.art, Spalten.kostenKlasse, Spalten.probe,
                    Spalten.minus };
    ...
    public String getHeaderToolTip(Object column) {
        ...
        case stern:
            return lib.getToolTipTxt("TblHeaderStern");
        case stufe:
            return lib.getToolTipTxt("TblHeaderStufe");
        case modis:
            return lib.getToolTipTxt("TblHeaderModis");
        case kosten:
            return lib.getToolTipTxt("TblHeaderKosten");
        case spezialisierungen:
            return lib.getToolTipTxt("TblHeaderSpezi");
        case auswahl:
            return lib.getToolTipTxt("TblHeaderAuswahl");
        case leitTalent:
            return lib.getToolTipTxt("TblHeaderLeittalent");
        case sorte:
            return lib.getToolTipTxt("TblHeaderTalentSorte");
        case art:
            return lib.getToolTipTxt("TblHeaderTalentArt");
        case kostenKlasse:
            return lib.getToolTipTxt("TblHeaderKostenklasse");
        case probe:
            return lib.getToolTipTxt("TblHeaderProbe");
        case plus:
            return lib.getToolTipTxt("TblHeaderPlusButton");
        case minus:
            return lib.getToolTipTxt("TblHeaderMinusButton");
        }
