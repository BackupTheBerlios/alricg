...
public class ProzessorUtilities {
	 ...
	 */
	public static void inspectWert(GeneratorLink link, LinkProzessor prozessor) {		
	 ...
	 */
	public static Eigenschaft getMaxEigenschaft(Eigenschaft[] eigenschaftArray, Held held) {
		int maxIndex = 0;
	 ...
	 * 			von Faehigkeiten
	 */
	public static int getMinEigenschaftWert(List<HeldenLink> list, Eigenschaft eigenschaft, Held held, int minMoeglicherWert) {
	 ...
	 */
	private static int getMinWertHelp(Eigenschaft[] eigenArray, Eigenschaft eigenschaft, int wert, Held held) {
