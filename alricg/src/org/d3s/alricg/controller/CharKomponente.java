...
/**
 * <u>Beschreibung:</u><br>
 * Eine Konstante für alle Charakter Komponenten die vorkommen können. Die einzehnen Konstanten sind mit
 * Zusatzinformationen angereichert.
 * 
 * @author V. Strelow
 */
public enum CharKomponente {
    rasse("rassen", "RAS"), kultur("kulturen", "KUL"), profession("professionen", "PRO"), zusatzProfession(
            "zusatzProfessionen", "ZPR"), vorteil("vorteile", "VOR"), gabe("vorteileGaben", "GAB"), nachteil(
